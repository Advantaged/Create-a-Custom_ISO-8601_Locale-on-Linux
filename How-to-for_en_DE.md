...
```
To read the Markdown-Code (`*.md`) open the `README.md` with every Linux editor, to read it like here, open it with `ghostwriter`, `vs-code`, `code` or even with a PDF reader.
